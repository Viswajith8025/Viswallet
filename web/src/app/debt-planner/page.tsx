...
import { PageHeader, PageContainer, StatCard, EmptyState, LoadingState } from "@/components/ui/page";
        ...
        <>
          ...
          <Card>
            ...
            <CardContent className="flex flex-wrap gap-3 pt-0">
              ...
              <div className="flex items-center gap-2">
                <label htmlFor="extra-payment" className="text-sm text-muted-foreground">
                  Extra/month (₹)
                </label>
                <Input
                  id="extra-payment"
          ...
          {debts.length === 0 ? (
            <EmptyState
              ...
              description="Add EMIs or borrowed loans to build a payoff plan."
            />
          ) : (
            <>
              <Card>
